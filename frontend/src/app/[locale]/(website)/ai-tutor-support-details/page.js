...
export default async function MathMentorLandingPage() {
    const t = await getTranslations("AiTutorPage");

    return (
        <div className="bg-orange-50/35 min-h-screen font-sans antialiased text-[#1e293b] pb-32 overflow-x-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 pt-20">
                ...
                <section className="grid md:grid-cols-2 gap-12 items-center mb-20 relative">
                    ...
                    <div className="relative flex items-center justify-center min-h-85">
                        ...
                        <div className="relative w-72 h-72 md:w-100 md:h-100 z-10 transition duration-300 hover:scale-[1.02]">
                            <Image
                                src="/AI-TutorImages/ComputerUsing.png"
                    ...
                    <div className="space-y-6">
                            ...
                            <Image src="/AI-TutorImages/lulu logo Top.png" alt="Support Icon" width={80} height={80} className="object-contain w-20 mx-auto" />
                       
                        <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                            {t("heroTitle")}
                        </h1>
                ...
                <section className="mb-5 max-w-4xl mx-auto">
                    <div className="bg-linear-to-r from-yellow-100 to-orange-200 rounded-4xl p-4 md:p-5.5 shadow-sm border border-cyan-100/60 relative overflow-hidden group">
                        <div className="relative aspect-video w-full rounded-[20px] overflow-hidden bg-white flex items-center justify-center shadow-inner">
                            <Image
                                src="/AI-TutorImages/Ask AI.png"
                ...
                <section className="mb-10 relative max-w-5xl mx-auto px-4">
                    ...
                    <div className="relative w-full">
                        ...
                        <div className="hidden md:block absolute left-0 bottom-0 transform -translate-x-[70%] z-0 pointer-events-none select-none">
                            <Image
                                src="/AI-TutorImages/Girl with Phone.png"
                        ...
                        <div className="hidden md:block absolute right-0 top-1/2 transform translate-x-[70%] -translate-y-1/2 z-0 pointer-events-none select-none">
                            <Image
                                src="/AI-TutorImages/StandingBoy.png"
                ...
                {/* SECTION 5: TABS */}
                <section className="bg-linear-to-tl from-orange-50 to-blue-50 border border-slate-100 rounded-2xl p-4 shadow-sm max-w-4xl mx-auto mb-28">
                    <div className="grid grid-cols-3 gap-2 text-center">
                        {[
                            { id: "overview", Icon:Brain, tabKey: "tab1", iconClass: " text-orange-600" },
                            { id: "tracking", Icon: SparklesIcon,   tabKey: "tab2", iconClass: "text-purple-600" },
                            { id: "history",  Icon: Zap,    tabKey: "tab3", iconClass: " text-blue-600" },
                ...
                <section className="max-w-4xl mx-auto relative ">
                    ...
                    <div className="absolute -right-7.5 md:-right-50.5 bottom-0 z-0 pointer-events-none select-none opacity-90">
                        <Image
                            src="/AI-TutorImages/bottom-r.png"
                            alt=""
                            width={200}
                            height={200}
                            className="h-full w-auto object-contain translate-y-[30%]" 
                        />
                    </div>
                    ...
                    <div className="absolute -left-7.5 md:-left-50.5 bottom-0 z-0 pointer-events-none select-none opacity-90">
                        <Image
                            src="/AI-TutorImages/bottom-l.png"
                            alt=""
                            width={200}
                            height={200}
                            className="h-full w-auto object-contain translate-y-[-50%] translate-x-[20%]" 
                        />
                    </div>

                    <div className="w-full bg-4 rounded-4xl p-5 md:p-11 text-center text-white relative shadow-xl shadow-purple-950/10 overflow-visible flex flex-col items-center justify-center min-h-57.5 z-10">

                        <div className="absolute -left-3.75 md:-left-12.5 bottom-0 md:bottom-10 h-12 md:h-41.25 z-20 pointer-events-none select-none">
                            <Image
                                src="/AI-TutorImages/LuLu lago footer.png"
                        ...
                        <div className="space-y-4 max-w-md mx-auto relative z-10 pl-8 md:pl-0">
                            ...
                            <div className="pt-2">
                                ...
                                <p className="text-[10px] text-purple-200/90 font-semibold mt-3 tracking-wide">
                                    {t("ctaHelper")}
                                </p>
                            </div>
                        </div>
